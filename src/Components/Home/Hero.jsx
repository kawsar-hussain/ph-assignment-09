...
const Hero = () => {
  return (
    <div className="bg-[#49e94926] py-10">
      <section className="w-[90%] md:w-[75%] lg:w-[60%] m-auto">
        <Swiper modules={[Autoplay, Pagination, Navigation]} autoplay={{ delay: 2000, disableOnInteraction: false }} pagination={{ clickable: true }} navigation loop speed={800} className="mySwiper">
          <SwiperSlide>
            <img className="w-full h-[250px] md:h-[350px] lg:h-[400px] object-cover rounded-xl" src="https://wallpapers.com/images/hd/green-flower-background-ze00991e4unypoys.jpg" alt="first image" />
          </SwiperSlide>

          <SwiperSlide>
            <img
              className="w-full h-[250px] md:h-[350px] lg:h-[400px] object-cover rounded-xl"
              src="https://w0.peakpx.com/wallpaper/488/641/HD-wallpaper-think-green-grown-nature-green-plant.jpg"
              alt="second image"
            />
          </SwiperSlide>
